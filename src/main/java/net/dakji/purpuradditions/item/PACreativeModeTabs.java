    ...
    public static final Supplier<CreativeModeTab> PURPUR_ADDITIONS_TAB = CREATIVE_MODE_TAB.register("purpur_additions_tab",
            () -> CreativeModeTab.builder().icon(() -> new ItemStack(PABlocks.PURPUR_STONE.get()))
                    ...
                    .displayItems((itemDisplayParameters, output) -> {
                        ...
                        output.accept(PABlocks.PURPUR_STONE_BRICKS);
                        output.accept(PABlocks.PURPUR_STONE_BRICK_SLAB);
                        output.accept(PABlocks.PURPUR_STONE_BRICK_STAIRS);
                        output.accept(PABlocks.PURPUR_STONE_BRICK_WALL);

                        output.accept(PABlocks.PURPUR_STONE_TILES);
                        output.accept(PABlocks.PURPUR_STONE_TILE_SLAB);
                        output.accept(PABlocks.PURPUR_STONE_TILE_STAIRS);
                        output.accept(PABlocks.PURPUR_STONE_TILE_WALL);
