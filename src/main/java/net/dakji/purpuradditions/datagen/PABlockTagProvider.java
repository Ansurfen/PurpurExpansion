...
public class PABlockTagProvider extends BlockTagsProvider {
    ...
    protected void addTags(HolderLookup.@NotNull Provider provider) {
        tag(BlockTags.MINEABLE_WITH_PICKAXE)
                ...
                .add(PABlocks.PURPUR_STONE_BRICKS.get())
                .add(PABlocks.PURPUR_STONE_BRICK_SLAB.get())
                .add(PABlocks.PURPUR_STONE_BRICK_STAIRS.get())
                .add(PABlocks.PURPUR_STONE_BRICK_WALL.get())
                .add(PABlocks.PURPUR_STONE_TILES.get())
                .add(PABlocks.PURPUR_STONE_TILE_SLAB.get())
                .add(PABlocks.PURPUR_STONE_TILE_STAIRS.get())
                .add(PABlocks.PURPUR_STONE_TILE_WALL.get())
