...
public class PABlocks {
    ...
    public static final DeferredBlock<StairBlock> PURPUR_STONE_BRICK_STAIRS = registerBlock("purpur_stone_brick_stairs", () -> new StairBlock(PABlocks.PURPUR_STONE_BRICKS.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(Blocks.STONE)));
    ...
    public static final DeferredBlock<StairBlock> PURPUR_STONE_TILE_STAIRS = registerBlock("purpur_stone_tile_stairs", () -> new StairBlock(PABlocks.PURPUR_STONE_TILES.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(Blocks.STONE)));
